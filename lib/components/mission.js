...
var component = {
    createNewMission: function(mId, missionInfo, playersMap, playersServerInfo, server) {
        return new Mission(mId, missionInfo, playersMap, playersServerInfo, server);
    },
    ...
    restoreMissionsFromDb: function(server) {
        ...
        server.db.find({}).toArray(function(err, result) {
            ...
            for (var i = 0; i < result.length; i++) {
                var mission = self.createNewMission(result[i].mId, result[i].info, result[i].playersMap, result[i].playersServerInfo, server);
